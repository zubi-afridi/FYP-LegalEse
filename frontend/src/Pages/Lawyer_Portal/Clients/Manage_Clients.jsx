                  ...
                  <tbody>
                    {records.map((d, i) => (
                      ...
                      >
                        ...
                        <td className={`${role==='admin'?'hidden':''} px-4 py-3 flex items-center justify-end space-x-3`}>
                          <Link to={`/Lawyer/${username}/View_Client/${d.id}`}>
                            <button>
                              <FaRegEye
                                size={16}
                          ...
                          <Link to={`/Lawyer/${username}/Edit_Client/${d.id}`}>
                            <button>
                              <FaRegEdit
                                size={16}
